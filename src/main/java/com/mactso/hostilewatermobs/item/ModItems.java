...
public class ModItems {
	...
	public static final Item SLIPPERY_BITER_GLAND = new SlipperyBiterGland ((new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1.0F).fast().alwaysEat().build())).rarity(Rarity.UNCOMMON).stacksTo(16));
	...
	public static final Item GURTY_GUTS = new Item((new Item.Properties()).rarity(Rarity.UNCOMMON));
	public static final Item GURTY_GLAND = new GurtyGland ((new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1.0F).fast().alwaysEat().build())).rarity(Rarity.UNCOMMON).stacksTo(16));
