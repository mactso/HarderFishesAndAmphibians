...
public class ModItems {
	...
	public static final Item SLIPPERY_BITER_GLAND = new SlipperyBiterGland ((new Item.Properties().food(new Food.Builder().hunger(3).saturation(1.0F).fastToEat().setAlwaysEdible().build())).group(ItemGroup.FOOD).maxStackSize(16)).setRegistryName("slippery_biter_gland");
	public static final Item SLIPPERY_BITER_SCALES = new Item((new Item.Properties()).group(ItemGroup.MATERIALS)).setRegistryName("slippery_biter_scales");
	...
	public static void register(IForgeRegistry<Item> forgeRegistry)
	{
		...
		forgeRegistry.registerAll(SLIPPERY_BITER_SCALES);		forgeRegistry.registerAll(SLIPPERY_BITER_SCALES);
	}
