...
public class HostileWaterMobsRecipe extends ShapelessRecipe {
	...
	public static class Serializer extends ShapelessRecipe.Serializer {
		...
		@Override
		public HostileWaterMobsRecipe read(ResourceLocation recipeId, JsonObject json) {
...
//		           throw new JsonParseException("Too many ingredients for shapeless recipe the max is " + (ShapedRecipe.getWidth() * ShapedRecipe.getHeight()));
		...
		@Override
		public HostileWaterMobsRecipe read(ResourceLocation recipeId, PacketBuffer buffer) {
		...
		public void write(PacketBuffer buffer, ShapelessRecipe recipe) {
			...
			buffer.writeString(((HostileWaterMobsRecipe) recipe).operation);
		}
	}
}
